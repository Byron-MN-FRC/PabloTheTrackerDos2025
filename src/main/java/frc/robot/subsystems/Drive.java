...
public class Drive extends SubsystemBase {
    ...
    */
    ...
    public void driveWithController(XboxController controller) {
        tankDrive.tankDrive(-controller.getLeftY()/2, -controller.getRightY()/2);
    }
   ...
   new SysIdRoutine(
      ...
      new SysIdRoutine.Mechanism(
         (volts) -> {
          ...
          // using phoenix logger, leave null
         null,
         this
      )
   );

   // commands for running characterization tests
